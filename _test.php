...
/* help/test */
twitteroauth_row('help/test', $twitter->get('help/test'), $twitter->http_code);
...
twitteroauth_row('statuses/public_timeline', $twitter->get('statuses/public_timeline'), $twitter->http_code);

/* statuses/public_timeline */
twitteroauth_row('statuses/home_timeline', $twitter->get('statuses/home_timeline'), $twitter->http_code);

/* statuses/friends_timeline */
twitteroauth_row('statuses/friends_timeline', $twitter->get('statuses/friends_timeline'), $twitter->http_code);

/* statuses/user_timeline */
twitteroauth_row('statuses/user_timeline', $twitter->get('statuses/user_timeline'), $twitter->http_code);

/* statuses/mentions */
twitteroauth_row('statuses/mentions', $twitter->get('statuses/mentions'), $twitter->http_code);

/* statuses/retweeted_by_me */
twitteroauth_row('statuses/retweeted_by_me', $twitter->get('statuses/retweeted_by_me'), $twitter->http_code);

/* statuses/retweeted_to_me */
twitteroauth_row('statuses/retweeted_to_me', $twitter->get('statuses/retweeted_to_me'), $twitter->http_code);

/* statuses/retweets_of_me */
twitteroauth_row('statuses/retweets_of_me', $twitter->get('statuses/retweets_of_me'), $twitter->http_code);
...
twitteroauth_row('statuses/update', $status, $twitter->http_code, $parameters);
...
twitteroauth_row($method, $twitter->delete($method), $twitter->http_code);

/* statuses/retweet */
$method = 'statuses/retweet/6242973112';
twitteroauth_row($method, $twitter->post($method), $twitter->http_code);
...
twitteroauth_row('users/search', $twitter->get('users/search', $parameters), $twitter->http_code, $parameters);
...
$list = $twitter->post($method, $parameters);
twitteroauth_row($method, $list, $twitter->http_code, $parameters);
...
$parameters = array('id' => 27831060);
$method = "{$user->screen_name}/{$list->id}/members";
twitteroauth_row($method, $twitter->delete($method, $parameters), $twitter->http_code, $parameters);
...
$dm = $twitter->post($method, $parameters);
twitteroauth_row($method, $dm, $twitter->http_code, $parameters);
...
twitteroauth_row($method, $twitter->get($method, $parameters), $twitter->http_code, $parameters);
